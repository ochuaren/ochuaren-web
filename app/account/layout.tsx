export default async function RootLayout({
  ...
  return (
    <div className="grid grid-cols-4 min-h-screen">
      <aside
        id="default-sidebar"
        className="hidden md:block h-fit left-0 z-40 transition-transform -translate-x-full sm:translate-x-0 bg-blue-700 border rounded shadow"
        aria-label="Sidebar"
      >
        <div className="px-3 py-4 overflow-y-auto text-white">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="/account/profile"
                className="flex items-center p-2 rounded-lg hover:text-black hover:bg-gray-100  group"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">我的帖子</span>
      ...
      <div className="p-4 col-span-4 md:col-span-3">{children}</div>
    </div>
  );
}
